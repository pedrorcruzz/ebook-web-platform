...
@section('content')
    <div class="flex justify-center items-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md">
            <h1 class="text-2xl font-bold mb-4 text-center text-indigo-600">Login</h1>
            ...
            <form method="POST" action="{{ route('auth.authenticate') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('email') }}" required placeholder="Seu email"
            ...
            <div class="text-center mt-4">
                <a href="{{ route('auth.register') }}" class="text-base text-indigo-600 hover:text-indigo-500">
